...
def main():
    ...
    data_train = datasets.ImageFolder(root=r'/home/data/mnist/train/', transform=tran_train)
    data_test = datasets.ImageFolder(root=r'/home/data/mnist/test/', transform=tran_test)
    ...
    # net_glob.load_state_dict(torch.load(r'/home/experiments/save_model/mnist.pth'))
    ...
    for epoch in range(1, args.epochs+1):
        ...
        for i in users:
            # if epoch == 3 and i == 0:
            #     client = TrainLocal(args, data_train, None, poison=0)
            # elif i == 0:
            #     client = TrainLocal(args, data_train, None, poison=0)
            # else:
        ...
        if acc > best_acc:
            torch.save(net_glob.state_dict(), f'./save_model/mnist.pth')
            best_acc = acc
