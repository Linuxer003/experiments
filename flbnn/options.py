...
def args_parser():
    ...
    # federated learning
    parser.add_argument('--epochs', type=int, default=50, help='number of the train epochs')
    parser.add_argument('--num_users', type=int, default=5, help='number of client chosen to upload the weight')
